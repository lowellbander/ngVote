"""
Django settings for priorityDB project.
...
SECRET_KEY = '9nn(9yg7f&c(+d2dsafkj=dpc6=+m8uxe8d3l1q)!rw!ffdfj=bk#+dz!&j'
...
ROOT_URLCONF = 'priorityDB.urls'

WSGI_APPLICATION = 'priorityDB.wsgi.application'

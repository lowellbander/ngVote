"""
Django settings for voteDB project.
...
SECRET_KEY = 'b*eq&dxo(z)=$!s27aywf7&6@#j-m@sqdevxt%iui)!bjm0n1z'
...
ROOT_URLCONF = 'voteDB.urls'

WSGI_APPLICATION = 'voteDB.wsgi.application'
